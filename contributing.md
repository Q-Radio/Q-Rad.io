...
1. Fork the central repo at [https://github.com/temporary-zebra/SuperMusic.git](https://github.com/temporary-zebra/SuperMusic.git)

1. Clone the forked repo to your local machine

    ```bash
    $ git clone https://github.com/USERNAME/SuperMusic.git
    ```
